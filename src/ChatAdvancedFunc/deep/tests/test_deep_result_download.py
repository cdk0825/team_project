...
def test_deep_result_download_file_extension(driver, download_dir, download_type, expected_ext):
    ...
    print("\n==============================")
    print(f"[TEST START] DEEP Result Download ({expected_ext})")
